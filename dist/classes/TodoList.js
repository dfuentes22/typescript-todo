...
export class TodoList {
    ...
    removeTodoItem(btn, item, input, btnAdd) {
    ...
    editTodoItem(btnEdit, item, label, todo, input, btnAdd) {
    ...
    saveTodoItem(btnEdit, btnSave, label, todo, input, btnAdd) {
